...
/***/ function(module, exports, __webpack_require__) {
	...
	var _guessWhoCharacters = __webpack_require__(167);
	
	var _guessWhoCharacters2 = _interopRequireDefault(_guessWhoCharacters);
	
	var _questions = __webpack_require__(168);
	...
	window.onload = function () {
	  _reactDom2.default.render(_react2.default.createElement(_Game2.default, { characters: _guessWhoCharacters2.default, questions: _questions2.default }), document.getElementById('app'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _QuestionSelector = __webpack_require__(162);
	
	var _QuestionSelector2 = _interopRequireDefault(_QuestionSelector);
	
	var _singleCharacterCheck = __webpack_require__(163);
	
	var _singleCharacterCheck2 = _interopRequireDefault(_singleCharacterCheck);
	
	var _multipleCharacterCheck = __webpack_require__(164);
	
	var _multipleCharacterCheck2 = _interopRequireDefault(_multipleCharacterCheck);
	
	var _questionDeleter = __webpack_require__(165);
	
	var _questionDeleter2 = _interopRequireDefault(_questionDeleter);
	
	var _isGameFinished = __webpack_require__(166);
	
	var _isGameFinished2 = _interopRequireDefault(_isGameFinished);
	...
	var Game = function (_React$Component) {
	  ...
	  _createClass(Game, [{
	    ...
	    value: function handleCharacterClick(event) {
	      ...
	      var updatedGrid = (0, _isGameFinished2.default)(gridAfterCharacterCheck, addToGuesses, currentBestScore);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Character = __webpack_require__(161);
	...
	var Board = function Board(props) {
	  return _react2.default.createElement(
	    ...
	    props.characters.map(function (character, index) {
	      return _react2.default.createElement(_Character2.default, { character: character, key: index, index: index,
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        this.props.questions.map(function (question, index) {
	          return _react2.default.createElement(
	            "option",
	            { key: index, value: question.value },
	            question.question
	          );
	        })
	      );
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = singleCharacterCheck;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var multipleCharacterCheck = function multipleCharacterCheck(grid, chosenCharacter, selectValue) {
	...
	var chosenValue = function chosenValue(selectValue, grid, boolean) {
	...
	exports.default = multipleCharacterCheck;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = questionDeleter;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isGameFinished = function isGameFinished(grid, currentGuesses, bestScore) {
	
	  grid.forEach(function (character) {
	    if (character.name === "It's me!!!!!") {
	      if (bestScore === 0 || currentGuesses < bestScore) {
	        localStorage.setItem('GuessWhoC7BestScore', JSON.stringify(currentGuesses));
	      }
	...
	var gameFinished = function gameFinished(grid) {
	...
	exports.default = isGameFinished;
